...
ifeq ($(DEBUG), 1)
THEOS_PACKAGE_FILENAME = "debug_package"
else
...
internal-package::
	$(ECHO_NOTHING)$(FAKEROOT) -r dpkg-deb -b -Zgzip "$(THEOS_STAGING_DIR)" "$(THEOS_PACKAGE_DIR)/$(THEOS_PACKAGE_FILENAME).deb" $(STDERR_NULL_REDIRECT)$(ECHO_END)
